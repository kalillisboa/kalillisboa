...
public class FuncionarioController {
	...
	private TipoFuncionarioRepository tipofuncionario;

	@Autowired
	public void autowired(TipoFuncionarioRepository tipofuncionario, FuncionarioRepository repositorio,
			EmpresaRepository empresa, CargoRepository cargo, SquadRepository squad) {
	...
	public String cadastrar(Model model) {
		...
		List<TipoFuncionario> tipofuncionarioLista = tipofuncionario.findAll();

		model.addAttribute("TipoFuncionario", tipofuncionarioLista);
	...
	@GetMapping("/funcionarios/alterar/{id}")
